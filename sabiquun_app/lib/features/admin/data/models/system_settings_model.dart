...
class SystemSettingsModel with _$SystemSettingsModel {
  ...
  const factory SystemSettingsModel({
    ...
    @JsonKey(name: 'whatsapp_business_account_id') String? whatsappBusinessAccountId,
  ...
  factory SystemSettingsModel.fromSettingsMap(Map<String, dynamic> settingsMap) {
    return SystemSettingsModel(
      ...
      whatsappEnabled: settingsMap['whatsapp_enabled']?.toString().toLowerCase() == 'true',
      whatsappPhoneNumberId: settingsMap['whatsapp_phone_number_id']?.toString(),
      whatsappBusinessAccountId: settingsMap['whatsapp_business_account_id']?.toString(),
      whatsappAccessToken: settingsMap['whatsapp_access_token']?.toString(),
      whatsappApiVersion: settingsMap['whatsapp_api_version']?.toString(),
  ...
  Map<String, dynamic> toSettingsMap() {
    return {
      ...
      'whatsapp_api_version': whatsappApiVersion ?? 'v18.0',
